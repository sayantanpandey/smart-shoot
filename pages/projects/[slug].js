    ...
    <>
      ...
      <div className="min-h-screen px-4 py-8 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <Link
            href="/projects"
            className="inline-flex items-center mb-8 text-sm text-emerald-600 hover:text-emerald-800 font-medium transition-colors duration-200 group"
          >
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden animate-fade-in-up">
            {/* Header Section */}
            <div className="relative p-8 pb-6 bg-gradient-to-br from-emerald-50 to-purple-50">
              {/* Category Badge */}
              {project.category && (
                <div className="absolute top-6 right-6">
                  <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-white/90 backdrop-blur-sm text-gray-700 border border-white/20 shadow-sm">
            ...
            <div className="relative">
              <div className="relative w-full h-[500px] md:h-[600px] bg-gradient-to-br from-gray-100 to-gray-200">
                {!imageError ? (
                  <>
                    {/* Loading Skeleton */}
                    {!imageLoaded && (
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                    <div className="text-center p-8">
                      <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-emerald-100 to-purple-100 rounded-3xl flex items-center justify-center transform rotate-3">
                        <svg className="w-12 h-12 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                        </svg>
                      </div>
                      <h3 className="text-lg font-semibold text-gray-700 mb-2">Image Unavailable</h3>
                      <p className="text-sm text-gray-500">Unable to load the project image</p>
                    </div>
                  </div>
                )}
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {project.category && (
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">{project.category.charAt(0).toUpperCase() + project.category.slice(1)}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {project.lens && (
                      <div className="flex items-start">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-900">Lens</h4>
                          <p className="text-gray-600">{project.lens}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {project.uploadedAt && (
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">{formatDate(project.uploadedAt)}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {project.id && (
                      <div className="flex items-start">
                        <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center mr-4 mt-1">
                          <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                        </div>
                        <div>
                          <h4 className="font-semibold text-gray-900">Project ID</h4>
                          <p className="text-gray-600 font-mono text-sm break-all">{project.id}</p>
                        </div>
                      </div>
                    )}
                  </div>
            ...
            <div className="px-8 pb-8">
              <div className="border-t border-gray-200 pt-6">
                <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
                  <Link
                    href="/projects"
                    className="inline-flex items-center px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-lg transition-all duration-200 hover:scale-105"
                  >
